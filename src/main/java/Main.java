...
public class Main {
    ...
    private static SystemUserService systemUserService = new SystemUserService(new SystemUserRepository());
    ...
    public static void main(String[] args) {
        ...
        if(systemUserService.authenticateUser(input)){
            ...
            String opt = ValidationUtils.validateInput(input,"\nDo you want to continue? [y/n]: ","^[yYnN]$").toLowerCase();
            if(opt.equalsIgnoreCase("y")){
                systemUserService.authenticateUser(input);
            }else{
